...
<head>
    ...
    <!-- Page Title -->
    <title>STRUMO | Category: Ukulele</title>
</head>
    ...
    <header class="bg-light p-3">
        <div class="container mt-2 mb-1">
            <div class="text-center text-dark font">
                <h1 class="display-4 fw-bolder font">Category: UKULELE</h1>
            </div>
        </div>
    </header>
    <!-- Section-->
    <?php
    $featuredProducts = mysqli_query($mysqli, "SELECT * FROM products WHERE category = 'Ukulele'");
    ?>
