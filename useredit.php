        ...
        <div class="container font">
            <div class="d-flex justify-content-center align-items-center">
                ...
                <div class="d-flex justify-content-center m-auto mt-1 ">
                    <div class="card wid text-black border" style="border-radius: 21px;">
                        <div class="card-body">
                            <a href="./index.php" class="myA d-flex justify-content-end">Go back</a>
                            <form method="POST" class="mx-3 mx-md-5">

                                <img src="./assets/images/logos/strumo.png" width="35%" alt="Strumo" class="center">
                                ...
                                <div class="form-group mb-2">
                                    <b>Enter New Name</b>
                                    <input type="text" name="fname" class="border-secondary form-control" value="<?php echo $res['fullname']; ?>">
                                </div>

                                <div class="form-group mb-2">
                                    <b>Enter New Email</b>
                                    <input type="email" name="email" class="border-secondary form-control" value="<?php echo $res['email']; ?>">
                                </div>

                                <div class="form-group mb-2">
                                    <b>Enter New Address</b>
                                    <input type="text" name="address" class="border-secondary form-control" value="<?php echo $res['address']; ?>">
                                </div>

                                <div class="form-group mb-2">
                                    <b>Enter New Phone No</b>
                                    <input type="text" name="phone" class="border-secondary form-control" value="<?php echo $res['phone']; ?>">
                                </div>

                                <div class="form-group mb-2">
                                    <b>Enter New Username</b>
                                    <input type="text" name="username" class="border-secondary form-control" value="<?php echo $res['username']; ?>">
                                </div>

                                <div class="form-group mb-2">
                                    <b>Enter New Password</b>
                                    <input type="password" name="password" class="border-secondary form-control" value="<?php echo $res['password']; ?>">
                                </div>
